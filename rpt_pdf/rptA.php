...
$bil = 0;
$tempVendor='';
$qty100=0; $qty50=0; $qty20=0; $qty10=0; $totalAmt=0;	
if ($GetRpt->RowCount() <> 0) { 
	...
	<table style="width: 100%;" align="center">
		<tr style="width: 100%; font-size: 9pt;">	
			...
			<td valign="middle" align="center"  bgcolor="#C0C0C0" rowspan="2"><b>TARIKH ARAHAN</b></td>
			...
			<td valign="middle" align="center"  bgcolor="#C0C0C0" colspan="4"><b>DENOMINASI UNIT</b></td>
...
//				$pdf->WriteHTML($HTML, isset($_GET['vuehtml']));			
				$HTML .= '	
				<tr><td colspan="9"><hr style="border-size:0.5px; border-color:#999999"></td></tr>
				<tr style="font-size: 9pt;">
					...
					<td align="right" valign="top" style="width: 150px;">'.number_format($totalAmt,2).'&nbsp;</td>
				</tr>
				<tr><td colspan="9"><hr style="border-size:0.5px; border-color:#999999"></td></tr>
			...
			$HTML .= '
			<tr style="font-size: 9pt;">	
				<td colspan="9" height="30" valign="middle"><b>'.$GetRpt->fields('vendorCode').' : '.$GetRpt->fields('vendorName').'</b></td>
			</tr>';
		}
		$bil++;
		...
		<tr style="font-size: 9pt;">
			...
			<td align="left" valign="center">'.todate('d/m/Y',$GetRpt->fields('instructDate')).'</td>
			<td align="left" valign="top" style="width: 300px;">'.$GetRpt->fields('atmNo').' - '.$GetRpt->fields('atmLoc').'</td>
			<td align="center" valign="top" style="width: 100px;">'.$GetRpt->fields('type').'</td>
			...
			<td align="right" valign="top" style="width: 150px;">'.number_format($GetRpt->fields('totalValue'),2).'&nbsp;</td>
		</tr>';
